...
public class LoginPage extends Page {
    ...
    public boolean clickLoginBtn(){
        if (buttonLogin.isDisplayed()) {buttonLogin.click(); return true;}
        else System.out.println("Button Войти doesn't exist"); return false;
    }
    ...
    public boolean disablerememberMy(){
        if (rememberMe.isSelected()) {rememberMe.click(); return true;}
        return true;
    }
